...
| :--- | :--- |
| 🏛️ **[HANDOFF_WIKI.md](HANDOFF_WIKI.md)** | Master technical architecture & clinical developer handoff wiki (v2.1.1-PROD), covering dual-sided architecture, FHIR export, multi-tenant RBAC, and Gap-Closure Chunks 1–6. |
| 🗺️ **[ROADMAP.md](ROADMAP.md)** | Comprehensive engineering roadmap detailing delivered milestones (Phases 3–8, Gap-Closure Chunks 1–6) and remaining backlog. |
...
| 🧪 **[testing.md](testing.md)** | Comprehensive test pyramid, full test inventory table, 754-test passing Vitest summary (78 test files), fuzzing vectors, and CI/CD validation gates. |
...
| 📜 **[changelog.md](changelog.md)** | Semantic versioning history, release milestones (`v1.0.0` to `v2.1.1`), and complete Git commit trajectory. |
